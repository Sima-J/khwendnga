  ...
  return (
    <section className="w-full h-screen bg-gradient-to-r from-lightPurple to-blue flex flex-col-reverse md:flex-row justify-center items-center overflow-hidden">
      <div className="relative w-full md:w-1/2 mt-20 md:mt-0 flex justify-center items-center transform scale-75 md:scale-100">
        <div
          className="relative z-10 bg-gray-800 rounded-lg 
        w-terminal custom-shadow hidden lg:block mx-auto"
        >
          <div className="flex items-center">
            <div className="flex items-center space-x-2 p-3">
              <div className="bg-red rounded-full w-3 h-3"></div>
              <div className="bg-yellow rounded-full w-3 h-3"></div>
              <div className="bg-green-500 rounded-full w-3 h-3"></div>
            </div>
            <h1 className="text-lightPurple font-bold">Khwendnga</h1>
          </div>
          <video
            autoPlay
            loop
      ...
      <div
        className="w-full lg:w-fit lg:h-fit   flex mx-auto justify-center   py-10 items-center transform scale-75 md:scale-100
        md:translate-x-0 translate-x-10 md:translate-y-0 translate-y-10"
      >
        <img className="w-fit h-fit " src={bannerHome} alt="bannerHome" />
