      ...
      <div className="mx-auto  bg-white ">
        <div className="flex flex-col lg:flex-row p-4 lg:p-8 justify-center items-center lg:items-stretch w-full">
          <table className="w-full bg-white ">
            <thead>
              <tr className="w-full h-16 border-gray-300 dark:border-gray-200  font-[400] text-darkPurple border-b border-t py-8">
                <th className="   pr-6 text-left text-sm tracking-normal leading-4">
                  Student
                </th>
